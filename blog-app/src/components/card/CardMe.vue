<!--<template>
  <el-card>
    <h1 class="me-author-name">我的昵称</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;我的地点</span>
      <span><i class="me-icon-job"></i> &nbsp;我的职业</span>
    </div>
...
<style scoped>
  .me-author-name {
    text-align: center;
    font-size: 30px;
    border-bottom: 1px solid rgb(25, 71, 41);
  }
