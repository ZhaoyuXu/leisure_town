    ...
    <el-container>
      <base-header :simple=true>
        <el-col :span="4" :offset="2">
          <div class="me-write-info">发文章</div>
        </el-col>
        <el-col :span="4" :offset="6">
          <div class="me-write-btn">
            <el-button round @click="publishShow">文章发布</el-button>
            <el-button round @click="cancel">取消发布</el-button>
          </div>
        </el-col>
      </base-header>
      ...
      <el-dialog title="文章摘要 文章分类 文章标签"
        ...
        <div slot="footer" class="dialog-footer">
          <el-button @click="publishVisible = false">取消发布</el-button>
          <el-button type="primary" @click="publish('articleForm')">文章发布</el-button>
        </div>
      </el-dialog>
    </el-container>
  </div>
